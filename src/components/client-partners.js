...
export default class ClientPartners extends Component {
	constructor(props) {
		...
		this.state = {
			...
			items: [
				<div className='item'><img src={logoImg1} alt='logo' /></div>,
				<div className='item'><img src={logoImg2} alt='logo' /></div>,
				<div className='item'><img src={logoImg3} alt='logo' /></div>,
				<div className='item'><img src={logoImg4} alt='logo' /></div>,
				<div className='item'><img src={logoImg5} alt='logo' /></div>,
				<div className='item'><img src={logoImg6} alt='logo' /></div>,
				<div className='item'><img src={logoImg7} alt='logo' /></div>,
				<div className='item'><img src={logoImg8} alt='logo' /></div>,
				<div className='item'><img src={logoImg9} alt='logo' /></div>,
				<div className='item'><img src={logoImg10} alt='logo' /></div>,
				<div className='item'><img src={logoImg11} alt='logo' /></div>,
				<div className='item'><img src={logoImg12} alt='logo' /></div>,
				<div className='item'><img src={logoImg13} alt='logo' /></div>,
				<div className='item'><img src={logoImg14} alt='logo' /></div>,
				<div className='item'><img src={logoImg13} alt='logo' /></div>,
				<div className='item'><img src={logoImg15} alt='logo' /></div>,
				<div className='item'><img src={logoImg16} alt='logo' /></div>,
				<div className='item'><img src={logoImg17} alt='logo' /></div>,
				<div className='item'><img src={logoImg18} alt='logo' /></div>,
				<div className='item'><img src={logoImg19} alt='logo' /></div>,
				<div className='item'><img src={logoImg20} alt='logo' /></div>,
				<div className='item'><img src={logoImg21} alt='logo' /></div>,
				<div className='item'><img src={logoImg22} alt='logo' /></div>,
				<div className='item'><img src={logoImg23} alt='logo' /></div>,
				<div className='item'><img src={logoImg24} alt='logo' /></div>,
				<div className='item'><img src={logoImg25} alt='logo' /></div>,
				<div className='item'><img src={logoImg26} alt='logo' /></div>,
				<div className='item'><img src={logoImg27} alt='logo' /></div>,
				<div className='item'><img src={logoImg28} alt='logo' /></div>,
				<div className='item'><img src={logoImg29} alt='logo' /></div>				
			]
		}
	}
	componentDidMount() {
